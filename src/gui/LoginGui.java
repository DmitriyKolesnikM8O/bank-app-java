...
public class LoginGui extends BaseFrame{
    ...
    protected void addGuiComponents() {
        ...
        passportLabel.setFont(new Font("Arial", Font.PLAIN, 20));

        add(passportLabel);

        JPasswordField passportField = new JPasswordField();
        passportField.setBounds(20, 230, getWidth() - 50, 40);
        passportField.setFont(new Font("Arial", Font.PLAIN, 28));
        
        add(passportField);

        JButton LoginButton = new JButton("Login");
        LoginButton.setBounds(20, 330, getWidth() - 50, 40);
        ...
        registeredLabel.setBounds(0, 400, getWidth() - 10, 30);
